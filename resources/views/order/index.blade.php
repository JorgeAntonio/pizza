        ...
        <div class="row justify-content-center">
            <div class="card">
                <div class="card-header">Order
                    <a href="{{ route('pizza.index') }}" style="float: right" class="btn btn-success btn-sm m-1">View pizzas</a>
                    <a href="{{ route('pizza.create') }}" style="float: right" class="btn btn-primary btn-sm m-1">Add new pizza</a>
                </div>
                <div class="card-body">
